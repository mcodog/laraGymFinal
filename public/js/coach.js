    ...
    $("#coachSubmit").on('click', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var tr = $("<tr data-id=" + data.coach.id + ">");
