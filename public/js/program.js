$(document).ready(function () {
    $("form[name='newSessionForm']").validate({
        rules: {
            image_upload: {
                required: true,
            },
            ...
            days: {
                required: true, // At least one checkbox must be selected
            }
        },
        messages: {
            ...
            coach: "Please select a coach.",
            difficulty: "Please select the difficulty level.",
            cost: {
    ...
    $("#sessionSubmit").on('click', function (e) {
        ...
        var $form = $("form[name='newSessionForm']");
        if ($form.validate().form()) { // Validate form and check if it's valid
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data);
                    $("#newSessionModal").fadeOut(500, function() {
                    ...
                    var tr = $("<tr>").attr('data-id', data.program.id);
