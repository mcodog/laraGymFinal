...
<body>
    <div id="app" class="d-flex">
        @guest
        @else
        <div class="d-flex flex-column flex-shrink-0" style="width: 5rem; height:100vh; background-color:rgb(79, 70, 229);">
            <a href="/" class="d-block p-3 link-dark text-decoration-none" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
                <svg viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg" fill="#e3e3e3">
            ...
            <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                ...
                <li class="nav-item {{ request()->is('products') ? 'actives' : '' }}">
                    <a href="{{ url('/') }}" class="nav-link py-3 " title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Customers">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="white" class="bi bi-columns-gap" viewBox="0 0 16 16">
            ...
            <div class="dropdown border-top">
                ...
                <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser3" style="color:white;">
                    ...
                    <li><a class="dropdown-item" id="logoutButton" onclick="event.preventDefault();
